...
export default function DonatorRegistrationPage() {
    ...
    const handleSumbit = (e) => {
        ...
        apiProvider.postDonator(username, phoneNumber, profilePic)
        .then(res => {
    ...
    <div>
        ...
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-md w-full space-y-8">
            ...
            <h2 className="mt-6 text-center text-2xl font-bold text-gray-900">Register as a Donator</h2>
